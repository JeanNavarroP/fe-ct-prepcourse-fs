...
function breakStatement(num) {
   ...
   if(seInterrumpe) return "Se interrumpió la ejecución";
   return newArray;

   //otra opcion mas sencilla sin break
   // var newArray = [];
   // for(let i = 0; i < 10; i++){
